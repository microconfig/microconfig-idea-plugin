...
public interface MicroconfigApi {
     ...
     */
    Map<String, String> resolvePropertyValueForEachEnv(String currentLine, File projectDir);

    /**
     * @return resolved placeholder values for each env: env -> value
     */
    Map<String, String> resolveOnePlaceholderForEachEnv(String placeholder, File projectDir);
